...
define('FTS_COMBINED_STREAMS_CURRENT_VERSION', '1.0.7'); // Affects updater files.
...
if (!is_plugin_active('feed-them-social/feed-them.php') && !isset($single_feed_active)) {
    ...
    add_action('admin_notices', 'fts_required_php_check_combined_feeds');
     ...
     * @since 1.5.6
     */
    function fts_required_php_check_combined_feeds() {
