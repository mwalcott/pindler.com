...
.social-feed-element strong{
    <?php if($sfbap1_profile_picture == '1' && $sfbap1_theme_selection == 'template2'){echo 'display: none !important;';}?>
}
.social-feed-element .media-object{
    <?php if($sfbap1_profile_picture == '1' && $sfbap1_theme_selection == 'template2'){echo 'display: none !important;';}?>
...
.social-feed-container-<?php echo $id; ?> .text-wrapper{
    <?php if($sfbap1_profile_picture == '1' && $sfbap1_theme_selection == 'template2'){echo 'margin-bottom: 10px !important;';}?>
