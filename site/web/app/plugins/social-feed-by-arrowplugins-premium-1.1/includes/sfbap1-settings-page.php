...
<main>
  ...
  <label id="sfbap1-tab2-label" for="sfbap1-tab2">Social Feed + Account Settings</label>
    ...
    <table id="sfbap1_style_selection_option">
      <tr>
       <td>
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input id="sfbap1_feed_style_blog_style" type="radio" name="sfbap1_feed_style" value="blog_style" <?php echo ($sfbap1_feed_style == 'blog_style')? 'checked="checked"':''; ?> /> 
            <label for="sfbap1_feed_style_blog_style"><strong>Blog Style</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input id="sfbap1_feed_style_masonry" type="radio" name="sfbap1_feed_style" value="masonry" <?php echo ($sfbap1_feed_style == 'masonry')? 'checked="checked"':''; ?> /> 
            <label for="sfbap1_feed_style_masonry"><strong>Masonry</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
...
<br/>
    ...
    <table id="sfbap1_theme_selection_table">
      <tr>
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input type="radio" id="sfbap1_theme_selection_template0" name="sfbap1_theme_selection" value="template0" <?php echo ($sfbap1_theme_selection == 'template0')? 'checked="checked"':''; ?> />
            <label for="sfbap1_theme_selection_template0"><strong>Dark</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input type="radio" id="sfbap1_theme_selection_template1" name="sfbap1_theme_selection" value="template1" <?php echo ($sfbap1_theme_selection == 'template1')? 'checked="checked"':''; ?> />
            <label for="sfbap1_theme_selection_template1"><strong>Pinterest Like Layout</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input type="radio" id="sfbap1_theme_selection_template2" name="sfbap1_theme_selection" value="template2" <?php echo ($sfbap1_theme_selection == 'template2')? 'checked="checked"':''; ?> />
            <label for="sfbap1_theme_selection_template2"><strong>Modern Light</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input type="radio" id="sfbap1_theme_selection_template3" name="sfbap1_theme_selection" value="template3" <?php echo ($sfbap1_theme_selection == 'template3')? 'checked="checked"':''; ?> />
            <label for="sfbap1_theme_selection_template3"><strong>Modern Dark</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
        ...
        <td>
          <p style="text-align: center;margin: 0;">
            <input type="radio" id="sfbap1_theme_selection_template4" name="sfbap1_theme_selection" value="template4" <?php echo ($sfbap1_theme_selection == 'template4')? 'checked="checked"':''; ?> />
            <label for="sfbap1_theme_selection_template4"><strong>Space White</strong></label>
          </p>
          <p style="text-align: center;margin: 5px;">
  ...
  <div class="switch">
              ...
              <p style="font-size: 1.3em;"><strong>Enter Facebook Page: </strong> www.facebook.com/<input type="text" placeholder="google" style="display: inline-block;" name="sfbap1_facebook_page_id" value="<?php echo $sfbap1_facebook_page_id; ?>" ></p>
        ...
        <td>
          <input style="margin-left: 15px;display: block;" type="number" min="1" max="100" id="sfbap1_number_of_photos" name="sfbap1_number_facebook" value="<?php if($sfbap1_number_facebook == ''){ echo '20' ;}else{ echo $sfbap1_number_facebook; } ?>" /> 
        </td>
      </tr>
              </table>
            </article>
...
<table>
    ...
    margin-top: -9px;" for="sfbap1_show_photos_from_id"><strong>Username:</strong></label> 
              ...
              <td>
                <input style="display:  inline-block;;" type="text" id="sfbap1_show_photos_from_id_value" name="sfbap1_user_id_twitter" placeholder="@twitter" value="<?php echo $sfbap1_user_id_twitter; ?>" /> <strong>Example: @audi</strong>
              </td>
            </tr>
            <tr>
              <td>
                <input style="display: inline-block;" type="radio" id="sfbap1_show_photos_from_hashtag"   name="sfbap1_show_photos_from_twitter" value='hashtag'<?php checked( "hashtag", $sfbap1_show_photos_from_twitter); ?>  /> 
                <label style="    background: none;
    color: black;
    box-shadow: none;
    text-shadow: none;
    ...
    margin-top: -9px;" for="sfbap1_show_photos_from_hashtag"><strong>Hashtag:</strong></label> 
              ...
              <td>
                <input style="display:  inline-block;;" type="text" id="sfbap1_show_photos_from_hashtag_value" placeholder="#sunshine" name="sfbap1_hashtag_twitter" value="<?php echo $sfbap1_hashtag_twitter; ?>" /> <strong>Example: #hastag</strong>
              </td>
            </tr>
          </table>
        </td>
 ...
 <table style="display: block;">
        ...
        <td>
          <input style="margin-left: 15px;display: block;" type="number" min="1" max="100" id="sfbap1_number_of_photos" name="sfbap1_number_twitter" value="<?php if($sfbap1_number_twitter == ''){ echo '20' ;}else{ echo $sfbap1_number_twitter; } ?>" /> 
        </td>
      </tr>
              </table>
...
<div class="switch"></div></label>
    ...
    margin-top: -9px;" for="sfbap1_show_photos_from_id_instagram"><strong>Username:</strong></label> 
              ...
              <td>
                <input style="display:  inline-block;;" type="text" id="sfbap1_show_photos_from_id_value" name="sfbap1_user_id_instagram" placeholder="@twitter" value="<?php echo $sfbap1_user_id_instagram; ?>" /> <strong>Example: @audi</strong>
              </td>
            </tr>
            <tr>
              <td>
                <input style="display: inline-block;" type="radio" id="sfbap1_show_photos_from_hashtag_instagram"   name="sfbap1_show_photos_from_instagram" value='hashtag'<?php checked( "hashtag", $sfbap1_show_photos_from_instagram); ?>  /> 
                <label style="    background: none;
    color: black;
    box-shadow: none;
    text-shadow: none;
    ...
    margin-top: -9px;" for="sfbap1_show_photos_from_hashtag_instagram"><strong>Hashtag:</strong></label> 
              ...
              <td>
                <input style="display:  inline-block;;" type="text" id="sfbap1_show_photos_from_hashtag_value" placeholder="#sunshine" name="sfbap1_hashtag_instagram" value="<?php echo $sfbap1_hashtag_instagram; ?>" /> <strong>Example: #hastag</strong>
              </td>
            </tr>
          </table>
        </td>
 ...
 <table style="display: block;">
        ...
        <td>
          <input style="margin-left: 15px;display: block;" type="number" min="1" max="100" id="sfbap1_number_of_photos" name="sfbap1_number_instagram" value="<?php if($sfbap1_number_instagram == ''){ echo '20' ;}else{ echo $sfbap1_number_instagram; } ?>" /> 
        </td>
      </tr>
              </table>
            </article>
...
<div class="switch"></div></label>
        ...
        <td>
          <input style="margin-left: 15px;display: block;" type="number" min="1" max="100" id="sfbap1_number_of_photos" name="sfbap1_number_pinterest" value="<?php if($sfbap1_number_pinterest == ''){ echo '20' ;}else{ echo $sfbap1_number_pinterest; } ?>" /> 
        </td>
      </tr>
              </table>
...
<div class="switch"></div></label>
        ...
        <td>
          <input style="margin-left: 15px;display: block;" type="number" min="1" max="100" id="sfbap1_number_of_photos" name="sfbap1_number_vk" value="<?php if($sfbap1_number_vk == ''){ echo '20' ;}else{ echo $sfbap1_number_vk; } ?>" /> 
        </td>
      </tr>
              </table>
