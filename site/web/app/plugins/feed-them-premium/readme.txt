...
== Changelog ==
= Version 1.7.1 Wednesday, October 11th, 2017 =
   * NEW: Facebook Options: Customize the Load More text and No More Posts, No More Photos or No More Videos text.
   * NEW: Instagram Shortcode: Now you can choose the Load More button width and margin when creating a shortcode.
   * NEW: Twitter Options: Customize the Load More text and No More Posts
   * NEW: Instagram Options: Customize the color of the Load More button and the text.
   * NEW: Instagram Options: Customize the Load More and No More Photos text.
   * NEW: Instagram Shortcode: Create a Location feed.
